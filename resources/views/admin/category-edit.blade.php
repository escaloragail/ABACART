...
<div class="main-content-inner">
                            <div class="main-content-wrap">
                                ...
                                <!-- edit-category -->
                                <div class="wg-box">
                                    <form class="form-new-product form-style-1" action="{{ route('admin.category.update', $category->Category_ID) }}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        @method('PUT')
                                        <fieldset class="name">
                                        ...
                                        <fieldset class="name">
                                            ...
                                            <input class="flex-grow" type="text" placeholder="Category Slug" name="slug"
                                                tabindex="0" value="{{ $category->category_slug }}" aria-required="true" required="">
                                        </fieldset>
